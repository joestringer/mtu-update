...
var (
	...
	// period determines how frequently the MTU update logic should run.
	period int
...
func init() {
	...
	flags.IntVarP(&period, "period", "p", 300, "Run once every x seconds")
...
func run(cmd *cobra.Command) {
	...
	if period < 5 {
		log.Fatalf("Specified period %d too short", period)
	}
